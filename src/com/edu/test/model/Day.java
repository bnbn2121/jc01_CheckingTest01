...
public class Day {
	...
	@Override
	public int hashCode() {
		return Objects.hash(date, temperatureEvening, temperatureMidday, temperatureMorning);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Day other = (Day) obj;
		return Objects.equals(date, other.date) && temperatureEvening == other.temperatureEvening
				&& temperatureMidday == other.temperatureMidday && temperatureMorning == other.temperatureMorning;
	}
